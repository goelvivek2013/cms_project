...
class EmploysControllerTest < ActionController::TestCase
  ...
  test "should create employ" do
    assert_difference('Employ.count') do
      post :create, employ: { address: @employ.address, contact: @employ.contact, first_name: @employ.first_name, last_name: @employ.last_name }
    end
  ...
  test "should update employ" do
    patch :update, id: @employ, employ: { address: @employ.address, contact: @employ.contact, first_name: @employ.first_name, last_name: @employ.last_name }
    assert_redirected_to employ_path(assigns(:employ))
  end
